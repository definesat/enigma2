...
HaveGZkernel = True
if getMachineBuild() in ('cc1','h9','vuzero4k','u5','u5pvr','sf5008','et13000','et1x000',"vuuno4k","vuuno4kse", "vuultimo4k", "vusolo4k", "spark", "spark7162", "hd51", "hd52", "sf4008", "dags7252", "gb7252", "vs1500","h7",'xc7439','8100s'):
	HaveGZkernel = False
...
class ImageBackup(Screen):
	...
	def doFullBackup(self, DIRECTORY):
		...
		elif "tar.bz2" in self.ROOTFSTYPE.split() or SystemInfo["HaveMultiBoot"] or self.MACHINEBUILD in ("u5","u5pvr","cc1"):
			self.MKFS = "/bin/tar"
