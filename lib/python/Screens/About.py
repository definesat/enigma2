...
def getAboutText():
	...
	if getMachineBuild() in ('vusolo4k','vuultimo4k','vuzero4k'):
		...
		cpuMHz = "   (1,3 GHz)"
	elif getMachineBuild() in ('u5','u5pvr','h9','cc1'):
		cpuMHz = "   (1,6 GHz)"
	...
	if getMachineBuild() not in ('h9','vuzero4k','sf5008','et13000','et1x000','hd51','hd52','vusolo4k','vuuno4k','vuuno4kse','vuultimo4k','sf4008','dm820','dm7080','dm900','dm920', 'gb7252', 'dags7252', 'vs1500','h7','xc7439','8100s','u5','u5pvr','cc1'):
